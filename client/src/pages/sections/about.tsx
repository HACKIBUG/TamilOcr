...
import tamilImage from "@/assets/images/image3.jpg";
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-dark-600 dark:text-gray-300">
            Preserving and digitizing Tamil's rich literary heritage for future
            generations
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-bold">
              Why Digitize Tamil Historical Documents?
            </h3>
            <p className="text-dark-600 dark:text-gray-300 leading-relaxed">
              Tamil is one of the world's oldest classical languages with a rich
              literary tradition spanning thousands of years. However, many
              historical manuscripts and documents are deteriorating or
              difficult to access.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-dark-600 dark:text-gray-400">
                    Digitizing fragile manuscripts ensures they survive for
                    future generations.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-dark-600 dark:text-gray-400">
                    Creating searchable text allows scholars worldwide to study
                    these materials.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-dark-600 dark:text-gray-400">
                    Our system utilizes TrOCR and IndicBERT models specifically
                    fine-tuned for Tamil script recognition.
                  </p>
                </div>
              </div>
            </div>
