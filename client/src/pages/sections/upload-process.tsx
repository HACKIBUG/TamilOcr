...
export default function UploadProcessSection() {
  ...
  const uploadMutation = useMutation({
    mutationFn: async (formData: FormData) => {
      const response = await apiRequest("POST", "/api/documents/upload", undefined, formData);
  ...
  const processMutation = useMutation({
    mutationFn: async (docId: number) => {
      const response = await apiRequest("POST", `/api/documents/${docId}/process`);
      return response.json();
    },
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      if (!uploadedDocId) {
        ...
        formData.append("layoutAnalysisEnabled", layoutAnalysisEnabled.toString());
    ...
    <section id="process" className="py-20 bg-gray-50 dark:bg-dark-900">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Upload & Process</h2>
            ...
            <Tabs defaultValue="document" className="w-full">
              <div className="border-b border-gray-200 dark:border-dark-700">
                <TabsList className="bg-transparent border-b-0">
                  <TabsTrigger 
                    value="document" 
                    className="data-[state=active]:border-b-2 data-[state=active]:border-primary-600 data-[state=active]:text-primary-600 rounded-none px-6 py-4 font-medium"
                  >
                    Document Processing
                  </TabsTrigger>
                  <TabsTrigger 
              ...
              <TabsContent value="document" className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center">
                        <Checkbox 
                          ...
                          onCheckedChange={(checked) => setEnhancementEnabled(checked === true)}
                          className="mr-2"
                        />
                        <Label htmlFor="enhance" className="text-sm">Apply image enhancement</Label>
                      </div>
                      ...
                      <div className="flex items-center">
                        <Checkbox 
                          ...
                          onCheckedChange={(checked) => setSpellCheckEnabled(checked === true)}
                          className="mr-2"
                        />
                        <Label htmlFor="spellCheck" className="text-sm">Perform NLP-based correction</Label>
                      </div>
                      ...
                      <div className="flex items-center">
                        <Checkbox 
                          ...
                          onCheckedChange={(checked) => setLayoutAnalysisEnabled(checked === true)}
                          className="mr-2"
                        />
                        <Label htmlFor="layoutAnalysis" className="text-sm">Detect document layout</Label>
                      </div>
                      
                      <div className="mt-3">
                        <Label htmlFor="ocr-mode" className="block text-sm font-medium mb-1">OCR Mode</Label>
                        <select 
                          id="ocr-mode" 
                          value={ocrMode}
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <div className="flex items-center">
                          <RadioGroupItem id="format-txt" value="txt" className="mr-2" />
                          <Label htmlFor="format-txt" className="text-sm">Plain Text (.txt)</Label>
                        </div>
                        
                        <div className="flex items-center">
                          <RadioGroupItem id="format-pdf" value="pdf" className="mr-2" />
                          <Label htmlFor="format-pdf" className="text-sm">Searchable PDF (.pdf)</Label>
                        </div>
                        
                        <div className="flex items-center">
                          <RadioGroupItem id="format-json" value="json" className="mr-2" />
                          <Label htmlFor="format-json" className="text-sm">Structured Data (.json)</Label>
                        </div>
                      </RadioGroup>
                ...
                <div className="mt-8 flex justify-end">
                  ...
                  >
                    {processing ? (
                      ...
                      <>
                        <WandSparkles className="mr-2 h-5 w-5" /> Process Document
                      </>
                    )}
                  </Button>
                </div>
                ...
                {result && (
                  <div className="mt-10 fade-in">
                    <h3 className="font-medium text-lg mb-4">Processing Results</h3>
              ...
              <TabsContent value="batch" className="p-6">
                <div className="text-center py-12">
                  ...
                  <p className="text-dark-600 dark:text-gray-400 mb-6">
                    Process multiple documents at once with our batch processing feature.
                  </p>
