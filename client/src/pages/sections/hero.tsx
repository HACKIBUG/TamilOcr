...
import tamilImage from "@/assets/images/image1.jpg";
const heroBackgroundUrl =
  "https://images.unsplash.com/photo-1595426496987-37c7105de1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80";
...
export default function HeroSection() {
  return (
    ...
    >
      <div className="absolute inset-0 gradient-overlay bg-gradient-to-b dark:to-[rgba(18,18,18,0.95)] light:from-[rgba(250,250,250,0.85)] light:to-[rgba(250,250,250,0.95)]"></div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg md:text-xl text-dark-600 dark:text-gray-300 max-w-xl">
                Transform historical Tamil manuscripts and documents into
                searchable, editable digital text with our advanced AI
                recognition system.
              </p>
            </div>
            ...
            <div className="pt-4">
              <p className="text-dark-500 dark:text-gray-400 text-sm flex items-center gap-2">
                ...
                Advanced AI with 88% accuracy for Tamil script recognition
              </p>
            </div>
          </div>
              ...
              <div className="p-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-3">
                    <p className="text-sm font-medium text-dark-500 dark:text-gray-400">
                      Original Document
                    </p>
                    <img
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-gray-50 dark:bg-dark-900 p-3 rounded-lg h-64 overflow-y-auto tamil-text">
                      <p className="text-dark-800 dark:text-gray-300 leading-relaxed">
                        பழந்தமிழ் இலக்கியங்களில் ஒன்றான சிலப்பதிகாரம் கண்ணகி
                        மற்றும் கோவலன் கதையை விவரிக்கிறது. இது இளங்கோவடிகளால்
                        எழுதப்பட்டது. இந்த இலக்கியம் தமிழ் மக்களின் வாழ்க்கை
                        முறை, பண்பாடு, மற்றும் கலாச்சாரத்தை காட்டுகிறது. மேலும்,
                        அரசியல் மற்றும் சமூக உறவுகளை விளக்குகிறது. தமிழ்
                        மொழியின் செழுமையும் வளமும் இந்த இலக்கியத்தில்
                        வெளிப்படுகிறது.
                      </p>
                    </div>
                  </div>
